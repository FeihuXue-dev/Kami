...
- **Code.** Shiki-based static syntax highlighting when `bash skills/kami/scripts/ensure_shiki.sh` has installed its cached Node runtime; without it, PDFs still render and code stays monochrome.
